            ...
            <section class="bg-gray-50 min-h-screen flex items-center justify-center">
                ...
                <div class="bg-gray-100 flex rounded-2xl shadow-lg min-w-full justify-center p-5 items-center">
                    ...
                    <div class="md:w-1/2 px-8 md:px-16">
                        ...
                        <span class="text-xs mt-4 text-[#002D74]">Don't have account?
                            <Link href={'/signup'} className='ml-1 text-cyan-600'>
                                Sign up
                            </Link>
                        </span>
                        ...
                        <div class="mt-3 text-xs flex justify-between items-center text-[#002D74]">
                            ...
                            <Link href={'/signup'}><button class="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300">Register</button></Link>
                        </div>
                    </div>
                </div>
            </section>
